...
LOGIN_REDIRECT_URL = "/havneafgifter/blanket/opret/"
...
SAML = {
    ...
    "description": os.environ.get("SAML_SP_DESCRIPTION") or "Havneafgifter",
    ...
    "metadata": {"local": ["/var/cache/havneafgifter/idp_metadata.xml"]},  # IdP Metadata
    "service": {
        "sp": {
