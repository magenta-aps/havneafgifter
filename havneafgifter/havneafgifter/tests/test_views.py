...
class TestTaxRateFormView(HarborDuesFormMixin, TestCase):
    ...
    def test_rendering(self):
        ...
        # Port tax rate row 2
        self.assertEqual(
            port_tax_rates_table_content[1]["Afgifter pr. bruttoton"],
        ...
        # Port tax rate row 3
        self.assertEqual(
            port_tax_rates_table_content[2]["Afgifter pr. bruttoton"],
            "Enhver skibstype, TestPort",
        )
        self.assertEqual(
        ...
        # Port tax rate row 4
        self.assertEqual(
            port_tax_rates_table_content[3]["Afgifter pr. bruttoton"],
        ...
        # Port tax rate row 5
        self.assertEqual(
            port_tax_rates_table_content[4]["Afgifter pr. bruttoton"],
            "Freighter, enhver havn",
        )
        self.assertEqual(
        ...
        # Port tax rate row 6
        self.assertEqual(
            port_tax_rates_table_content[5]["Afgifter pr. bruttoton"],
            "Freighter, TestPort",
        )
        self.assertEqual(
        ...
        # Port tax rate row 7
        self.assertEqual(
            port_tax_rates_table_content[6]["Afgifter pr. bruttoton"],
            "Freighter, TestPort",
        )
        self.assertEqual(
        ...
        # Port tax rate row 8
        self.assertEqual(
            port_tax_rates_table_content[7]["Afgifter pr. bruttoton"],
