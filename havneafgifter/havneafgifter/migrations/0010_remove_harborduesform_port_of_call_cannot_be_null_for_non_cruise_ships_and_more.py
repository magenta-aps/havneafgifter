# Generated by Django 5.0.4 on 2024-06-25 07:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='harborduesform',
            constraint=models.CheckConstraint(condition=models.Q(('status', 'DRAFT'), ('vessel_type', 'CRUISE'), ('nationality__isnull', False), _connector='OR'), name='nationality_cannot_be_null_for_non_drafts', violation_error_code='constraint_violated'),
        ),
        migrations.AddConstraint(
            model_name='harborduesform',
            constraint=models.CheckConstraint(condition=models.Q(('status', 'DRAFT'), ('vessel_type', 'CRUISE'), ('port_of_call__isnull', False), _connector='OR'), name='port_of_call_cannot_be_null_for_non_cruise_ships', violation_error_code='constraint_violated'),
        ),
        migrations.AddConstraint(
            model_name='harborduesform',
            constraint=models.CheckConstraint(condition=models.Q(('status', 'DRAFT'), ('vessel_type', 'CRUISE'), ('gross_tonnage__isnull', False), _connector='OR'), name='gross_tonnage_cannot_be_null_for_non_cruise_ships', violation_error_code='constraint_violated'),
        ),
        migrations.AddConstraint(
            model_name='harborduesform',
            constraint=models.CheckConstraint(condition=models.Q(('status', 'DRAFT'), ('vessel_type', 'CRUISE'), ('datetime_of_arrival__isnull', False), _connector='OR'), name='datetime_of_arrival_cannot_be_null_for_non_cruise_ships', violation_error_code='constraint_violated'),
        ),
        migrations.AddConstraint(
            model_name='harborduesform',
            constraint=models.CheckConstraint(condition=models.Q(('status', 'DRAFT'), ('vessel_type', 'CRUISE'), ('datetime_of_departure__isnull', False), _connector='OR'), name='datetime_of_departure_cannot_be_null_for_non_cruise_ships', violation_error_code='constraint_violated'),
        ),
        migrations.AddConstraint(
            model_name='harborduesform',
