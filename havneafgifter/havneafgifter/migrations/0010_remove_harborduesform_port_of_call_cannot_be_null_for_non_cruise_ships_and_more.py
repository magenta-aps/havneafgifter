...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='harborduesform',
            constraint=models.CheckConstraint(check=models.Q(('status', 'DRAFT'), ('vessel_type', 'CRUISE'), ('nationality__isnull', False), _connector='OR'), name='nationality_cannot_be_null_for_non_drafts', violation_error_code='constraint_violated'),
        ),
        migrations.AddConstraint(
            model_name='harborduesform',
