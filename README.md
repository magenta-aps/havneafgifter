...
```
cd existing_repo
git remote add origin https://git.magenta.dk/gronlandsprojekter/krydstogtafgift.git
git branch -M master
...
**It is important to install the mentioned npm packages while in the root directory of this repo.**
